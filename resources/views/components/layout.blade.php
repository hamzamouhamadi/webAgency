...
<head>
  ...
  <link rel="icon" href="images/webAgencyBlue.png" />
...
<body class="">
  <nav class="flex justify-between items-center h-20  bg-gradient-to-r from-sky-500 to-indigo-500">
      <a href="/"><img class="w-16 w-40 h-40" src="{{asset('images/webAgency.png')}}" alt="" class="logo" /></a>

    <ul class="flex space-x-6 mr-6 text-lg">
      @auth
      <li>
        <a href="/listings/create" class="right-10 bg-black rounded-lg text-white py-2 px-5">Post Service</a>
      </li>
